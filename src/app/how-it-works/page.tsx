...
export const metadata = {
  title: "Kemo IPTV | How IPTV Works – 3-Step Simple Streaming Setup",
  description:
    "Discover how Kemo IPTV delivers 4K live TV and sports in 3 simple steps. Learn how our Anti-Freeze servers work and get set up in minutes. See how it works!",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Discover how Kemo IPTV delivers 4K live TV and sports in 3 simple steps. Learn how our Anti-Freeze servers work and get set up in minutes. See how it works!",
    url: "https://www.kemo-iptv.shop/how-it-works",
    siteName: "Kemo IPTV",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "How Kemo IPTV Works - 3-Step Quick Streaming Setup",
      },
    ],
  },
};
...
export default function HowItWorksPage() {
  return (
    <main className="flex-col flex min-h-screen bg-white">
      {/* Page Hero Header */}
      <section className="relative pt-6 pb-14 sm:pt-8 md:pb-16 border-b border-slate-200 bg-slate-50/50">
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight leading-tight mb-4">
            Stream 4K IPTV in <span className="text-blue-600">Under 5 Minutes</span>
          </h1>
          <p className="text-slate-600 text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
            Cutting the cord has never been easier. No satellite dishes to mount, no technician visits, and zero binding contracts.
            Select a{" "}
            <Link href="/pricing" className="text-blue-600 font-semibold hover:underline">
              Kemo IPTV subscription plan
            </Link>
      ...
      {/* Why Choose Kemo IPTV - Pill Grid */}
      <section className="py-20 bg-white text-slate-900 border-b border-slate-200">
        <div className="max-w-[1000px] mx-auto px-6 text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
            Why Choose <span className="text-blue-600">Kemo IPTV</span>?
          </h2>
      ...
      <section className="py-20 bg-slate-900 text-white text-center">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-extrabold mb-4">
            Ready to Start Streaming With Kemo IPTV?
          </h2>
          <p className="text-slate-300 text-base md:text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
            Unlock 50,000+ live global channels, 200,000+ VOD releases, and 4K sports with instant credentials delivery and zero contracts.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link 
              href="/pricing" 
              className="btn-primary-kemo w-full sm:w-auto px-8 py-3.5 text-xs sm:text-sm font-extrabold uppercase tracking-wider"
            >
