...
type Category = "About Kemo IPTV" | "Setup & streaming" | "Plans & access" | "Payments & support";
...
const categories: { label: Category; icon: typeof CircleHelp }[] = [
  { label: "About Kemo IPTV", icon: CircleHelp },
...
const faqs: FAQItem[] = [
  {
    category: "About Kemo IPTV",
    question: "1. What is Kemo IPTV?",
    answer: (
      <>
        Kemo IPTV is a high-performance streaming service providing live TV channels, VOD movies, TV series, and sports channels in uncompressed 4K and Full HD quality. Explore our{" "}
  ...
  {
    category: "About Kemo IPTV",
    question: "2. Is Kemo IPTV compatible worldwide?",
    answer: (
      <>
        Yes. Kemo IPTV servers are distributed globally with load-balancing nodes, allowing seamless high-speed streaming anywhere in the world on any standard internet connection.
      </>
    ),
  },
  {
    category: "About Kemo IPTV",
    question: "3. What channels and content are included with Kemo IPTV?",
    answer: (
      <>
        Kemo IPTV features over 50,000 live channels covering sports, news, documentaries, and entertainment, along with 200,000+ regularly updated movies and series on demand. Check our <Link href="/channels" className="text-blue-600 font-semibold hover:text-blue-800 transition-colors">full channels catalog</Link>.
      </>
    ),
  },
  {
    category: "About Kemo IPTV",
    question: "4. Can I watch live sports and PPV events on Kemo IPTV?",
    answer: (
      <>
        Yes. Kemo IPTV includes extensive 60 FPS sports coverage for Champions League, Premier League, NFL, NBA, UFC PPV, Formula 1, and global tournaments. Explore our <Link href="/channels" className="text-blue-600 font-semibold hover:text-blue-800 transition-colors">sports channels</Link>.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Kemo IPTV works with compatible player apps on Firestick, Smart TVs (Samsung Tizen, LG webOS, Android TV), Apple TV, smartphones, tablets, and Windows/Mac PCs. Follow our <Link href="/installation" className="text-blue-600 font-semibold hover:text-blue-800 transition-colors">installation guides</Link>.
      </>
    ),
  },
  {
    category: "Setup & streaming",
    question: "1. How do I install Kemo IPTV on my device?",
    answer: (
      <>
  ...
  {
    category: "Setup & streaming",
    question: "2. Can I use Kemo IPTV on a Smart TV?",
    answer: (
      <>
        Yes. Kemo IPTV works smoothly on Samsung, LG, Sony, TCL, and Android TVs using players like IBO Player, Smart IPTV, or IPTV Smarters Pro. Follow our{" "}
  ...
  {
    category: "Setup & streaming",
    question: "5. Do I need a VPN to stream Kemo IPTV?",
    answer: (
      <>
...
export default function FAQ() {
  ...
  function sendSupportMessage(formData: FormData) {
    ...
    const text = encodeURIComponent(`Hello Kemo IPTV support,\n\nName: ${name}\nEmail: ${email}\nSubject: ${subject}\n\n${message}`);
    window.open(`https://wa.me/447882781998?text=${text}`, "_blank", "noopener,noreferrer");
  }

  return (
    <main className="flex-grow px-4 sm:px-6 pb-20 pt-6 sm:pt-8 bg-white text-slate-900">
      <div className="mx-auto max-w-[1140px]">
        <header className="mx-auto mb-12 max-w-3xl text-center md:mb-16">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-slate-600 leading-relaxed">
            Find answers to common questions about Kemo IPTV subscriptions, device installation, stream performance, and billing.
          </p>
        </header>
        ...
        <section className="mt-20 border-t border-slate-200 pt-16 sm:pt-20">
          ...
          <div className="grid gap-6 sm:grid-cols-3 max-w-3xl mx-auto">
            <a className="flex flex-col items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center hover:bg-white hover:border-blue-300 transition-all" href="mailto:support@kemo-iptv.shop">
              ...
              <span className="text-xs text-blue-600 font-semibold mt-1 break-all">support@kemo-iptv.shop</span>
            </a>
            <a className="flex flex-col items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center hover:bg-white hover:border-emerald-300 transition-all" href="https://wa.me/447882781998?text=Hello%20Kemo%20IPTV%20support%2C%20I%20need%20help." rel="noreferrer" target="_blank">
