  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2.5">
      ...
      <div className="relative bg-white text-slate-800 border border-slate-200/90 px-3.5 py-1.5 rounded-full text-xs font-semibold shadow-md flex items-center gap-2">
        ...
        <span>Chat with Kemo IPTV support</span>
      </div>
      
      {/* WhatsApp Icon Button */}
      <a
        href="https://wa.me/447882781998?text=Hello,%20I%20would%20like%20to%20request%20a%20free%20trial%20or%20ask%20a%20question%20about%20Kemo%20IPTV."
        target="_blank"
        rel="noreferrer"
        aria-label="Chat with Kemo IPTV on WhatsApp"
