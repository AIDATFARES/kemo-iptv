      ...
      <div className="relative mx-auto max-w-[1120px] px-5 sm:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {primaryFeatures.map((feature, index) => {
            ...
            return (
              <div key={feature.title} className="flex min-h-[285px] flex-col rounded-2xl border border-slate-200 bg-slate-50/60 p-6 hover:bg-white hover:border-blue-300 hover:shadow-md transition-all duration-200">
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-blue-100 text-blue-600"><Icon className="h-5 w-5" /></span>
